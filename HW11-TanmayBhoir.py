...
class University:
    ...
    def instructor_db(self):
        ...
        pt = PrettyTable(field_names=['CWID', 'Name', 'Dept', 'Course', 'Students'])
        DB_File = "G:/810A/sqlite/810_startup.db"
        db = sqlite3.connect(DB_File)
        query = "select Name, CWID, Dept, Course, count(g.Student_CWID) as total_students from HW11_instructors i join HW11_grades g on i.CWID=g.Instructor_CWID group by i.CWID, g.Course"
